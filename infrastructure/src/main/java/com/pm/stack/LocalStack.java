...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        if (Boolean.parseBoolean(System.getenv().getOrDefault("LOCALSTACK_ENABLE_DATABASES", "false"))) {
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "TXlTdXBlclNlY3JldEtleVRoYXRJc0F0TGVhc3QzMkJ5dGVzTG9uZzEyMyE="));

        if (authServiceDb != null) {
    ...
    private FargateService createFargateService(String id,
        ...
        if(db != null){
            ...
            envVars.put("SPRING_DATASOURCE_PASSWORD", "admin");
    ...
    private void createApiGatewayService() {
        ...
        CfnOutput.Builder.create(this, "ApiGatewayLocalEndpoint")
                .description("Local endpoint when LocalStack ELB does not provide a DNS name")
